...
class GameSpec extends AnyWordSpec:
    "A Game" should {
        ...
        "have a String representation of the Game" in {
            ...
            val game2 = Game(PlayerTurnState(), Cards(Set(Card(Symbol.Clubs, Value.Ace))), Cards(Set(Card(Symbol.Diamonds, Value.Ace))), Cards(Set(Card(Symbol.Hearts, Value.Ace))), Deck(32), "test")
